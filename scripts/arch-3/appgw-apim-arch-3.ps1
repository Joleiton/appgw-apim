...
#1######
#apim/service
$_apimServiceName = "apim1internalv2"  # API Management service instance name   
...
#2######
#apim/service
$_apimServiceName2 = "apim2internalv2"  # API Management service instance name   
