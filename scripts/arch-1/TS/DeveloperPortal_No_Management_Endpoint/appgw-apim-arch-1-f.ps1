...
#1######
#apim/service
$_apimServiceName = "apiminternala1v1f"  # API Management service instance name   
$_apimOrganization = "Microsoft"
$_apimAdminEmail = "joleiton@microsoft.com"

#apim/hostname
$_apim_gatewayHostname =  "apif.jlacloud.com"
$_apim_portalHostname = "portalf.jlacloud.com"
$_apim_managementHostname = "managementf.jlacloud.com"
